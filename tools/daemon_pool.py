...
class DaemonThreadPoolExecutor(ThreadPoolExecutor):
    ...
    def _adjust_thread_count(self) -> None:
        ...
        if num_threads < self._max_workers:
            ...
            # Python 3.14 moved initializer state behind a worker context and
            # changed ``_worker`` from (ref, queue, initializer, initargs) to
            # (ref, context, queue). Feature-detect the new executor contract
            # while retaining compatibility with 3.8-3.13.
