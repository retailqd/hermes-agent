...
- Set `agent.max_turns: 0` to disable iteration exhaustion. Provider, context-window, timeout, interrupt, and explicit cancellation safeguards still apply.
...
- When a finite budget reaches 100%, the agent stops and returns a summary of work done
